...
# --- CONFIGURATION ---
# We read these securely from Render Settings (DO NOT PASTE KEYS HERE)
...
# --- ROBUST MODEL LIST ---
# Tries the latest versions first, then falls back to reliable ones
MODELS_TO_TRY = [
    "gemini-1.5-flash",       # Standard, reliable
    "gemini-flash-latest",    # Newest update
